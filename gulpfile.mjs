...
// Task: Create the dist/images folder
async function ensureDistDir() {
  await mkdir("dist/images", { recursive: true });
}

// Tasks for checking files
async function checkFiles() {
  const files = await globby(
    "src/images/**/*.{png,jpg,jpeg,gif,svg,PNG,JPG,JPEG,GIF,SVG}",
  );
  if (files.length === 0) {
...
async function optimizeImages() {
  return src("src/images/**/*.{png,jpg,jpeg,gif,svg,PNG,JPG,JPEG,GIF,SVG}", {
    allowEmpty: true,
    encoding: false,
  })
    .pipe(
